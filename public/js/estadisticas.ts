$(document).ready(function () {
    //Cuando carga la pagina ejecuta la llamada ajax para generar el grafico
        var selector:string = $("#selector").val().toString();
...
function llamadaAjax(opcion:string):void{
        $.ajax({
...
function mostrarestado(respuesta):void{
    var options = {
...
function mostrarperiodo(respuesta):void{
    var options = {
        series: [{
...
function mostrarpermiso(respuesta):void{
    var options = {
