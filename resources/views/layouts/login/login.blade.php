    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse d-md-flex flex-row-reverse pt-mb-0" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                @if($seleccionado == 2)
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ route('restablecer.index') }}" style="text-decoration: underline;color: #7A01C9">Restablecer contraseña</a></li>
                @else
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ route('restablecer.index') }}">Restablecer contraseña</a></li>
                @endif
            </ul>
        </div>
    </div>
...
<header class="masthead">
    <div class="container col-12 col-lg-8 p-0">
        @yield('contenido')
    </div>
</header>
