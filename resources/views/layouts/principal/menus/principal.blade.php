...
@section('menucont')
    ...
    <a class="nav-link" href="{{route("crear")}}">
        <div class="sb-nav-link-icon"><svg style="margin-bottom: 3px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-plus" viewBox="0 0 16 16">
